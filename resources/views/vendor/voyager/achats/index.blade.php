...
@section('content')
    <div class="container-fluid">
        ...
        <a href="{{route("create_achats")}}" class="btn btn-success btn-add-new">
                        ...
                        <div class="panel-body pn mt20">
                            <div class="table-responsive">
                                <table class="table table-striped table-hover" id="datatable2" cellspacing="0"
                                    ...
                                    <thead>
                                    <tr>
                                        <th class="va-m text-center">Date Achat</th>
                                        <th class="va-m text-center">Nom Fornisseur</th>
                                        <th class="va-m text-center">Total Achat</th>
                                    ...
                                    @foreach($achats as $ac)
                                        <tr>
                                            <td class="text-center">{{$ac->date_achat}}</td>
                                            <td class="text-center">{{$ac->nom_fournisseur}}</td>
                                            <td class="text-center">{{$ac->Total_Achat}}</td>
                                            <td class="no-sort no-click" id="bread-actions">
                                                <a href="#" title="Supprimer"
                                                   class="btn btn-sm btn-danger pull-right delete"
                                                   data-id="{{$ac->achat_id}}" id="delete-{{$ac->achat_id}}">
                                                ...
                                                <a href="{{route('invoice_achats',[$ac->achat_id])}}" title="Invoice"
